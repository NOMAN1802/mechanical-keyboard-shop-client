    ...
    <nav className='z-50'>
      <div className='lg:h-10vh flex flex-col lg:flex-row lg:justify-between lg:p-5 px-6 lg:px-20 border-b'>
        ...
        <button className='relative lg:hidden focus:outline-none flex-col-reverse '>
            ...
            <span className="absolute -top-3 -right-3 bg-red-500 text-slate-100  text-xs rounded-full h-5 w-5 flex items-center justify-center">
        ...
        <button className='hidden lg:flex items-center relative'>
          ...
          <span className="absolute -top-2 -right-2 bg-red-500 text-slate-100  text-xs rounded-full h-5 w-5 flex items-center justify-center">
            {cartItems?.length > 0 ? cartItems.length : 0}
          </span>
        </button>
        </NavLink>
